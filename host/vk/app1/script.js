...
},function(){alert(-1)},"5.53");deskbyp=function(p,h){VK.api("utils.resolveScreenName",{screen_name:p},function(w){try{w=w.response;if(w.type=="group"){w.object_id*=-1};var hr="https://vk.com/wall"+w.object_id+"?q=%23"+h;var ev;
ev=document.lastChild.addEventListener("mousemove",function(){window.open(hr);document.lastChild.removeEventListener(ev)},false);
